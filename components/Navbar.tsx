...
const Navbar: React.FC<NavbarProps> = ({ onNavClick, cartCount, onOpenCart }) => {
  ...
  const textColorClass = 'text-[#2C2A26]';
    ...
    <>
      ...
      >
        <div className="max-w-[1800px] mx-auto px-8 flex items-center justify-between">
          ...
          <div className={`hidden md:flex items-center gap-8 lg:gap-12 text-sm font-medium tracking-widest uppercase transition-colors duration-500 ${textColorClass}`}>
            <a href="#products" onClick={(e) => handleLinkClick(e, 'products')} className="hover:opacity-60 transition-opacity">Shop</a>
            <a href="#reviews" onClick={(e) => handleLinkClick(e, 'reviews')} className="hover:opacity-60 transition-opacity">Reviews</a>
